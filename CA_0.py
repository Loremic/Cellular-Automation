...
sc,z=pg.display.set_mode(var(1)),(var(1)[0]/10,var(1)[1]/10)
            ...
            match grid[i][j]:
                ...
                case 2:
                    if n==4 or n==6:
                        ...
                        Ac[i][j]=rm.randint(0,grid[i][j]-1)
                case 3:
                    if n==6 or n==9:
                        Ac[i][j]=3
                    else:
    ...
    for i in range(len(grid)):
        for j in range(len(grid[i])):
            ...
            match grid[i][j]:
                ...
                case 1: 
                    pg.draw.rect(screen,(255,255,255),pg.Rect(i*10,j*10,10.0,10.0))
                case 2:
                    pg.draw.rect(screen,(255,50,50),pg.Rect(i*10,j*10,10.0,10.0))
                case 3:
                    pg.draw.rect(screen,(50,255,50),pg.Rect(i*10,j*10,10.0,10.0))
                case 4:
                    pg.draw.rect(screen,(50,50,255),pg.Rect(i*10,j*10,10.0,10.0))
